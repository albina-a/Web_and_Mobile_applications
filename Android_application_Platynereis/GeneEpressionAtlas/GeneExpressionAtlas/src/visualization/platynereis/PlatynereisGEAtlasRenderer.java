...
public class PlatynereisGEAtlasRenderer {
	// Gene atlas
	private String modelPath = "data/GeneExpressionAtlas72_04.g3db";
	...
	// EM model
	/*private String modelPath = "data/model_em13b.g3db";	
	...
	public PlatynereisGEAtlasRenderer(){ //String m, float[] t, Vector3 camposition) { //String[] p,CheckBox[] gChecks
		...
		envir.add(new DirectionalLight().set(1f, 1f, 1f, 0f, 0f, -1f)); // key
